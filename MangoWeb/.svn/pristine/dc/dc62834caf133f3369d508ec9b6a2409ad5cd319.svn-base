package smartx.flex.modules.basic.system.sysdictionarymgmt
{
	...
	public class ExportSysButtonListener implements ListButtonListener
	{
		...
		public function ExportSysButtonListener()
		{
		...
		public function buttonClick(listPanel:BillListPanel):void
		{
			...
			var sql:String = "select value,valuecn,valueen,t.seqno,t.systemcomments,t.usercomments,t.type,t.abbrev,t.version,t.classid,t.attributeid,t.appmodule,t.state from bfbiz_sysdictionary t where t.type=0";
			
			xmlExportObject.fetchSql = sql;
			
			ConfirmUtil.confirm("是否导出系统数据?",listPanel,confirmHandler);
