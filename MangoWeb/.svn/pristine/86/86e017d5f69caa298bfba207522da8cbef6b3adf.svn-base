package smartx.flex.modules.basic.system.sysdictionarymgmt
{
	...
	public class ExportUserButtonListener implements ListButtonListener
	{
		...
		public function ExportUserButtonListener()
		{
		...
		public function buttonClick(listPanel:BillListPanel):void
		{
			...
			var sql:String = "select value,valuecn,valueen,t.seqno,t.systemcomments,t.usercomments,t.type,t.abbrev,t.version,t.classid,t.attributeid,t.appmodule,t.state from bfbiz_sysdictionary t where t.type=1";
			
			xmlExportObject.fetchSql = sql;
			
			ConfirmUtil.confirm("是否导出用户数据?",listPanel,confirmHandler);
