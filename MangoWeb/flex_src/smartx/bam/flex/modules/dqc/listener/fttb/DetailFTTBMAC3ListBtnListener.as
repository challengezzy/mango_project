package smartx.bam.flex.modules.dqc.listener.fttb
{
	...
	public class DetailFTTBMAC3ListBtnListener implements ListButtonListener
	{
		...
		public function DetailFTTBMAC3ListBtnListener(){
		...
		public function buttonClick(listPanel:BillListPanel):void{
			...
			var templetCode:String = "T_DQC_CMP_DETAIL_PONDEVICE_3";
			var title:String = "FTTB设备MAC比对资源中异常";
			var dataFilter:String = " COMP_DAY = '"+String(checkDayStr)+"' and type=3 and compareitem=7";
