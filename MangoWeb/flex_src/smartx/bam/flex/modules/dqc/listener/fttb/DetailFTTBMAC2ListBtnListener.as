package smartx.bam.flex.modules.dqc.listener.fttb
{
	...
	public class DetailFTTBMAC2ListBtnListener implements ListButtonListener
	{
		...
		public function DetailFTTBMAC2ListBtnListener(){
		...
		public function buttonClick(listPanel:BillListPanel):void{
			...
			var templetCode:String = "T_DQC_CMP_DETAIL_PONDEVICE_2";
			var title:String = "FTTB设备MAC比对仅网管有";
			var dataFilter:String = " COMP_DAY = '"+String(checkDayStr)+"' and type=2 and compareitem=7";
