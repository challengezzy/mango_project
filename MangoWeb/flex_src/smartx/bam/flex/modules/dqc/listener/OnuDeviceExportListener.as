package smartx.bam.flex.modules.dqc.listener
{
	...
	public class OnuDeviceExportListener implements ListButtonListener
	{
		...
		private var excelMTCode:String = "EXCEL_ONUDEVICE_CMPEXPORT";//excel导出格式定义
		
		public function OnuDeviceExportListener(){
		...
		public function buttonClick(listPanel:BillListPanel):void{
			...
			smartxFormService.excelExport(excelMTCode, queryCondition, "ONU设备比对后数据.zip");
			OperatingTipUtil.startOperat("生成ONU设备导出文件");
		...
		private function faultHandler(event:FaultEvent):void{
			OperatingTipUtil.endOperat();
			SmartXMessage.show("生成ONU设备的EXCEL文件失败",SmartXMessage.MESSAGE_ERROR,event.fault.faultString);
		}
