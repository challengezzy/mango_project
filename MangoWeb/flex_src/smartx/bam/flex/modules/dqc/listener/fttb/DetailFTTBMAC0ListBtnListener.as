package smartx.bam.flex.modules.dqc.listener.fttb
{
	...
	public class DetailFTTBMAC0ListBtnListener implements ListButtonListener
	{
		...
		public function DetailFTTBMAC0ListBtnListener(){
		...
		public function buttonClick(listPanel:BillListPanel):void{
			...
			//区别在于templetCode 和 dataFilter
			var checkDayStr:Object = data["COMP_DAY"] as String;
			var templetCode:String = "T_DQC_CMP_DETAIL_PONDEVICE";
			var title:String = "FTTB设备MAC地址一致";
			var dataFilter:String = " COMP_DAY = '"+String(checkDayStr)+"' and type=0 and compareitem=7";
