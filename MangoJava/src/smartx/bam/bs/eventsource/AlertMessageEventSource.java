 ...
 */
public class AlertMessageEventSource implements EventSourceAdapter, Runnable
{
	private Logger				logger			= Logger.getLogger( this.getClass() );

	public static final String	providerURI		= "DEFAULTPROVIDERNAME";
													
	public static final String	eventType		= "alertMessageEvent2";
	...
	public AlertMessageEventSource()
	{
	...
	public void run()
	{
		...
		while( isStart )
		{
			...
			data.put( "ACTIVATETIME", new Date() );
	...
	{
		AlertMessageEventSource t = new AlertMessageEventSource();
