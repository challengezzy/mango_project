/**************************************************************************
 * $RCSfile: Templet4CellEditor.java,v $  $Revision: 1.2.8.1 $  $Date: 2009/12/02 05:48:11 $
 **************************************************************************/
...
public class Templet4CellEditor extends AbstractCellEditor implements
    TableCellEditor {
        ...
        if (col == 1) {
            ...
            if (str.equals("树模板编码")) {
                ...
                return reflisttable;
                       ...
                       || str.equals("树关联字段")) {
                String treetableid = reftreetable.getRefID();
                ...
                String treetableid = reflisttable.getRefID();
                if (!treetableid.equals("")) {
 ...
 * $RCSfile: Templet4CellEditor.java,v $  $Revision: 1.2.8.1 $  $Date: 2009/12/02 05:48:11 $
 *
 * $Log: Templet4CellEditor.java,v $
 * Revision 1.2.8.1  2009/12/02 05:48:11  wangqi
 * *** empty log message ***
 *
