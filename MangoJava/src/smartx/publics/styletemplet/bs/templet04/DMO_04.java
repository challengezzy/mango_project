/**************************************************************************
 * $RCSfile: DMO_04.java,v $  $Revision: 1.5.6.1 $  $Date: 2009/01/16 08:51:28 $
 **************************************************************************/
...
public class DMO_04 {
	...
	public void dealDelete(String _dsName, String _bsInterceptName, BillVO _deleteobj) throws Exception{
		IBSIntercept_04 bsIntercept = getIntercept(_bsInterceptName); // 拦截器
 ...
 *
 * $Log: DMO_04.java,v $
 * Revision 1.5.6.1  2009/01/16 08:51:28  wangqi
 * *** empty log message ***
 *
 * Revision 1.1  2008/09/01 07:38:59  wangqi
 * *** empty log message ***
 *
 * Revision 1.5  2007/08/01 05:56:18  qilin
 * VERSION为null时用0进行比较
 *
 * Revision 1.4  2007/07/23 10:58:58  sunxf
 * Nova 20-14    平台层面更新数据的地方提供乐观锁控制，解决并发访问问题
 *
 * Revision 1.3  2007/05/31 11:22:11  sunxb
 * *** empty log message ***
 *
