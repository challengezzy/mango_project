/**************************************************************************
 * $RCSfile: Table_VO.java,v $  $Revision: 1.2 $  $Date: 2007/05/31 07:38:24 $
 **************************************************************************/
...
public class Table_VO extends AbstractTempletVO {

    /**
     *
     */
    private static final long serialVersionUID = 70615421901277756L;

    public HashVO getPub_templet_1Data() {
        HashVO vo = new HashVO(); //
        vo.setAttributeValue("templetcode", "tab"); //
        vo.setAttributeValue("templetname", "table");
        vo.setAttributeValue("tablename", "DB_TABLE");
        vo.setAttributeValue("pkname", "TNAME");
        vo.setAttributeValue("pksequencename", null);
        vo.setAttributeValue("savedtablename", "DB_TABLE");
