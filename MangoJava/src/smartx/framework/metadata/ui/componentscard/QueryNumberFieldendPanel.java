/**************************************************************************
 * $RCSfile: QueryNumberFieldendPanel.java,v $  $Revision: 1.3.2.4 $  $Date: 2009/06/12 05:25:16 $
 **************************************************************************/
 ...
 */
public class QueryNumberFieldendPanel extends AbstractNovaComponent implements INovaCompent {
        
	protected JFormattedTextField textField = null;

    public QueryNumberFieldendPanel(Pub_Templet_1_ItemVO _templetVO) {
        this._vo = _templetVO;
    ...
    public QueryNumberFieldendPanel(String _key, String _name) {
        this.key = _key + "END";
        this.name = "终止"+_name;
        init();
    }
 ...
 * $RCSfile: QueryNumberFieldendPanel.java,v $  $Revision: 1.3.2.4 $  $Date: 2009/06/12 05:25:16 $
 *
 * $Log: QueryNumberFieldendPanel.java,v $
 * Revision 1.3.2.4  2009/06/12 05:25:16  wangqi
 * *** empty log message ***
 *
 * Revision 1.3.2.3  2008/11/05 05:20:59  wangqi
 * *** empty log message ***
 *
