/**************************************************************************
 * $RCSfile: QueryUIDateTimestartPanel.java,v $  $Revision: 1.5.2.3 $  $Date: 2009/06/12 05:25:16 $
 **************************************************************************/
 ...
 */
public class QueryUIDateTimestartPanel extends AbstractNovaComponent implements INovaCompent {
    ...
    public QueryUIDateTimestartPanel(Pub_Templet_1_ItemVO _templetVO) {
        this._vo = _templetVO;
    ...
    public QueryUIDateTimestartPanel(String _key, String _name) {
        this.key = _key + "START";
        this.name ="起始" + _name;
     ...
     * (non-Javadoc)
     *
     * @see gxlu.pluto.ui.framework.compents.IPlutoCompent#setEditable(boolean)
     */
 ...
 * $RCSfile: QueryUIDateTimestartPanel.java,v $  $Revision: 1.5.2.3 $  $Date: 2009/06/12 05:25:16 $
 *
 * $Log: QueryUIDateTimestartPanel.java,v $
 * Revision 1.5.2.3  2009/06/12 05:25:16  wangqi
 * *** empty log message ***
 *
