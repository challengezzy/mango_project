/**************************************************************************
 * $RCSfile: GetCurrentDate.java,v $  $Revision: 1.2 $  $Date: 2007/05/31 07:38:25 $
 **************************************************************************/
...
public class GetCurrentDate2 extends PostfixMathCommand {

    private Date d_curr = null;
    public GetCurrentDate2() { // 这个参数必须要有，，，TNND，搞了半天，真是太不爽了.
