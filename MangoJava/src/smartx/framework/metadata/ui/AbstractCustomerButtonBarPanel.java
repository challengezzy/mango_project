/**************************************************************************
 * $RCSfile: AbstractCustomerButtonBarPanel.java,v $  $Revision: 1.3.8.2 $  $Date: 2009/12/21 02:57:27 $
 **************************************************************************/
 ...
 *
 */
public abstract class AbstractCustomerButtonBarPanel extends JPanel implements CustomerCtrlIFC {

    protected NovaInternalFrame parentFrame = null;
    ...
    public NovaInternalFrame getParentFrame() {
        return parentFrame;
    }

    public void setParentFrame(NovaInternalFrame parentFrame) {
 ...
 * Revision 1.3.8.2  2009/12/21 02:57:27  wangqi
 * *** empty log message ***
 *
 * Revision 1.3.8.1  2009/12/16 04:14:01  wangqi
 * *** empty log message ***
 *
