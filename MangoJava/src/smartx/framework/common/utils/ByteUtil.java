 ...
 *
 * <p>Title: ByteUtil </p>
 * <p>Description: 一些字节处理的工具函数，用于一些比较底层的基于字节的协议转换 </p>
...
public class ByteUtil {
  ...
  public static byte[] toHexBytes(int length, int hexlen, byte fillhead) {
    ...
    System.arraycopy(src, 0, dest,
                     hexlen - src.length > 0 ? hexlen - src.length : 0,
                     src.length);
...
//  }
  ...
  public static void showBytes(byte[] buf) {
    ...
    String hex = "";
    byte[] s = new byte[16];
    System.out.println("[BYTES INFO] : LENGTH = " + buf.length +
...
//    System.out.println(ByteUtil.getZteIHLRChecksum("HBHB".toCharArray())); // it is ok. B7BDB7BD
...
//    System.out.println(ByteUtil.getZtePCSChecksum(s));
    ...
    System.out.println(new String(ByteUtil.copyto(to, "hello!".getBytes(), 0,
                                                  10)));
    System.out.println(new String(ByteUtil.copyto(to, "Hello world!".getBytes(),
                                                  2,
                                                  15)));

    System.out.println(new String(ByteUtil.copy(to, 5, 6)));
    System.out.println(new String(ByteUtil.delete("Hello world".getBytes(), 5,
                                                  6)));
    System.out.println(new String(ByteUtil.insert(to, "Gogogo!".getBytes(), 5,
                                                  5)));
    ByteUtil.memset(length, (byte) '5', 10, 10);
    System.out.println(new String(length));
    System.out.println(new String(ByteUtil.insert(length, "Gogogo!".getBytes(),
                                                  8,
                                                  8)));
