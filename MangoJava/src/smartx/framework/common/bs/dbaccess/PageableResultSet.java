...
import smartx.framework.common.bs.dbaccess.ifc.Pageable;

/**
 * 对ResultSet进行分页扩展的的包装类
 * 
 * @author zzy
 * 
 */
public class PageableResultSet implements Pageable {
	...
	protected java.sql.ResultSet rs = null;// 继承的ResultSet方法，由该实例进行处理
	...
	public PageableResultSet(java.sql.ResultSet rs,int rowsCount) throws java.sql.SQLException {
		if (rs == null)
			throw new SQLException("given ResultSet is NULL", "user");
...
//		rs.beforeFirst();
	...
	public void gotoPage(int page) {
		...
		try {
			...
			System.out.println("PageableResultSet.gotoPage(" + page + ") 异常！" + e.getMessage());
		}
