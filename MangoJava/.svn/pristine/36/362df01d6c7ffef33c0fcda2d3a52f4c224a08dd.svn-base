/**************************************************************************
 * $RCSfile: GetTableStruct.java,v $  $Revision: 1.2 $  $Date: 2007/05/31 07:38:25 $
 **************************************************************************/
package smartx.framework.metadata.ui.exportnova;
...
public class GetTableStruct {
    ...
    public String getPub_TempleteItem() {
        ...
        sb_sql.append("  colorformula                     varchar2(2500),  --颜色公式 \r\n");
        ...
        sb_sql.append(
            "  constraint ck_pub_templet_1_item_5 check (listiseditable in('1','2','3','4')),  --列表是否可编辑 \r\n");
        ...
        sb_sql.append("comment on column pub_templet_1_item.colorformula is '颜色公式'; \r\n");
    ...
    public String getPub_Menu() {
        ...
        sb_sql.append(
            "  showintoolbar           char(1) default 'Y' CHECK(showintoolbar IN ('Y','N')) not null, --是否在工具栏显示 \r\n");
    ...
    public String getPub_Combox() {
        ...
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'性别','W','Women','女',null,2);\r\n");
        sb_sql.append("\r\n");
        sb_sql.append("\r\n");
        ...
        sb_sql.append("\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'平台控件类型','文本框','001','文本框',null,1);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'平台控件类型','数字框','002','数字框',null,2);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'平台控件类型','密码框','003','密码框',null,3);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'平台控件类型','下拉框','004','下拉框',null,4);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'平台控件类型','参照','005','参照',null,5);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'平台控件类型','多行文本框','006','多行文本框',null,6);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'平台控件类型','日历','007','日历',null,7);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'平台控件类型','颜色','008','颜色',null,8);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'平台控件类型','计算器','009','计算器',null,9);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'平台控件类型','文件选择框','010','文件选择框',null,10);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'平台控件类型','时间','011','时间',null,11);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'平台控件类型','大文本框','012','大文本框',null,12);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'平台控件类型','勾选框','013','勾选框',null,13);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'平台控件类型','图片选择框','014','图片选择框',null,14);\r\n");
        sb_sql.append("\r\n");
        sb_sql.append("\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'菜单路径','0','0','自定义Frame',null,1);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'菜单路径','11','11','1单表列',null,2);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'菜单路径','12','12','2单表列/卡',null,3);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'菜单路径','13','13','3单表树/卡',null,4);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'菜单路径','14','14','4双表树列',null,5);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'菜单路径','15','15','5双表树列/卡',null,6);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'菜单路径','16','16','6双表列列',null,7);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'菜单路径','17','17','7双表列列/卡',null,8);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'菜单路径','18','18','8主子表',null,9);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'菜单路径','19','19','9多子表',null,10);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'菜单路径','20','20','10主子孙表',null,11);\r\n");
        sb_sql.append("\r\n");
        sb_sql.append("\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'参与查询条件类型','1','001','快速查询',null,1);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'参与查询条件类型','2','002','通用查询',null,2);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'参与查询条件类型','3','003','不允许查询',null,3);\r\n");
        sb_sql.append("\r\n");
        sb_sql.append("\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'控件编辑属性设置','1','001','全部可编辑',null,1);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'控件编辑属性设置','2','002','仅新增可编辑',null,2);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'控件编辑属性设置','3','003','仅修改可编辑',null,3);\r\n");
        sb_sql.append(
            "insert into pub_ComboBoxdict values (s_pub_ComboBoxdict.nextval,'控件编辑属性设置','4','004','全部禁用',null,4);\r\n");
        sb_sql.append("\r\n");
        sb_sql.append("commit;\r\n");
        sb_sql.append("\r\n");
    ...
    public String getPub_FileUpload() {
        ...
        sb_sql.append(
            "  newfilename  varchar2(100),  --文件新名,即放在tomcat上的文件名,它是由序列加上oldfilename拼成的!!它同时也是应用表字段存储的真正内容 \r\n");
    ...
    public String getPub_News() {
        ...
        sb_sql.append(
            "  isscrollview                char(1) default 'N' check (isscrollview in ('Y','N')) not null,  --是否滚动 \r\n");
 ...
 * code format
 *
 * Revision 1.1  2007/05/17 06:02:22  qilin
 * no message
 *
