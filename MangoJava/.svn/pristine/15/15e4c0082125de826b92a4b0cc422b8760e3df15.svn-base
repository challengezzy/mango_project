/**************************************************************************
 * $RCSfile: Templet6CellEditor.java,v $  $Revision: 1.2.8.1 $  $Date: 2009/12/02 05:48:22 $
 **************************************************************************/
...
public class Templet6CellEditor extends AbstractCellEditor implements
    TableCellEditor {
        ...
        if (col == 1) {
            ...
            if (str.equals("主表编码")) {
                ...
                if (!listtableid.equals("")) {
                    ...
                    prifield = new UIRefPanel_List("templet6_treefield",
                        "templet6_treefield",
 ...
 * $RCSfile: Templet6CellEditor.java,v $  $Revision: 1.2.8.1 $  $Date: 2009/12/02 05:48:22 $
 *
 * $Log: Templet6CellEditor.java,v $
 * Revision 1.2.8.1  2009/12/02 05:48:22  wangqi
 * *** empty log message ***
 *
