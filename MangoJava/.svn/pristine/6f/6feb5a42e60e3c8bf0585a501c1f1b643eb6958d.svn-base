/**************************************************************************
 * $RCSfile: GetCurrentDBDate.java,v $  $Revision: 1.2 $  $Date: 2007/05/31 07:38:25 $
 **************************************************************************/
...
public class GetCurrentDBDate extends PostfixMathCommand {
    ...
    public void run(Stack inStack) throws ParseException {
        ...
        str_sql = "select to_char(sysdate,'yyyy-mm-dd') from dual";
 ...
 * no message
 *
 * Revision 1.7  2007/03/30 08:11:31  shxch
 * *** empty log message ***
 *
