/**************************************************************************
 * $RCSfile: UITimeSetPanel_List.java,v $  $Revision: 1.6.2.1 $  $Date: 2008/06/11 11:41:19 $
 **************************************************************************/
...
public class UITimeSetPanel_List extends JPanel implements INovaCompent {
    ...
    public UITimeSetPanel_List(Pub_Templet_1_ItemVO _templetVO) {
    ...
    public UITimeSetPanel_List(String _key, String _name, String _refSQL) {
        this.key = _key; //
        this.name = _name; //
        initialize();
    }
    ...
    private void initialize() {
        ...
        btn_ref = new JButton(UIUtil.getImage("images/platform/time.gif"));
    ...
    private void onButtonClicked() {
        ...
        TimePicker tp = new TimePicker(this, "时间设置", null);
 ...
 * $RCSfile: UITimeSetPanel_List.java,v $  $Revision: 1.6.2.1 $  $Date: 2008/06/11 11:41:19 $
 *
 * $Log: UITimeSetPanel_List.java,v $
 * Revision 1.6.2.1  2008/06/11 11:41:19  wangqi
 * *** empty log message ***
 *
 * Revision 1.6  2007/11/28 05:35:28  wangqi
 * *** empty log message ***
 *
 * Revision 1.5  2007/07/25 06:38:01  lst
 * no message
 *
 ...
 * no message
 *
 * Revision 1.5  2007/03/28 10:52:14  shxch
 * *** empty log message ***
 *
 * Revision 1.4  2007/03/28 09:51:08  shxch
 * *** empty log message ***
 *
 * Revision 1.3  2007/01/31 08:57:19  shxch
 * *** empty log message ***
 *
