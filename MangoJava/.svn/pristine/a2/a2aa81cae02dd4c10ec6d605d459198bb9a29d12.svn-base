/**************************************************************************
 * $RCSfile: Templet2RefPanel.java,v $  $Revision: 1.2 $  $Date: 2007/05/31 07:39:02 $
 **************************************************************************/
...
public class Templet2RefPanel extends AbstractTempletRefPars {
    ...
    public Templet2RefPanel(String initString) {
        init(initString);
    }

    public Templet2RefPanel() {
        init("");
    }
    ...
    private void init(String initstring) {
        ...
        Templet2CellEditor editor = new Templet2CellEditor();
    ...
    private class MyTableModel extends AbstractTableModel {
        ...
        public boolean isCellEditable(int r, int c) {
            if ( (keys.get(r).equals("模板编码") && c == 0) || c == 2 || c == 3) {
                return false;
            }
            return true;
        }
    ...
    protected String bsInformation() {
        return "BS拦截器,需要实现IBSIntercept_02";
    }

    protected String uiInformation() {
        return "UI拦截器,需要实现IUIIntercept_02";
    }
}
/**************************************************************************
 * $RCSfile: Templet2RefPanel.java,v $  $Revision: 1.2 $  $Date: 2007/05/31 07:39:02 $
 *
 * $Log: Templet2RefPanel.java,v $
