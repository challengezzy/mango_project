...
public class BillListPanelService {
	...
	public BillListPanelVO getBillListPanelVOByPage(String templetCode,
		...
		try {
			...
			vo.setRealSQL(sql);
			//zhangzy20140917 简化计算总数SQL
			String sqlCount = FormServiceUtil.getSQL4Count(templetVO, condition, nce);
			int count = service.getBillListRowCountByDS(datasource, sqlCount,templetVO, nce);
