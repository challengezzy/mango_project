/**************************************************************************
 * $RCSfile: NovaConstants.java,v $  $Revision: 1.2.8.1 $  $Date: 2009/08/14 09:23:47 $
 **************************************************************************/
...
public class NovaConstants {
    ...
    // 消息窗口标题
    public static final String MESSAGE_INFO_TITLE = "提示";

    public static final String MESSAGE_WARN_TITLE = "警告";

    public static final String MESSAGE_ERROR_TITLE = "错误";

    public static final String MESSAGE_CONFIRM_TITLE = "确认";
     ...
     * 登录验证模式
     */
    public static final String SYS_LOGIN_LOCAL="LOCAL";//本地认证
    public static final String SYS_LOGIN_3TH="OTHER";//第三方认证
 ...
 * $RCSfile: NovaConstants.java,v $  $Revision: 1.2.8.1 $  $Date: 2009/08/14 09:23:47 $
 *
 * $Log: NovaConstants.java,v $
 * Revision 1.2.8.1  2009/08/14 09:23:47  wangqi
 * *** empty log message ***
 *
