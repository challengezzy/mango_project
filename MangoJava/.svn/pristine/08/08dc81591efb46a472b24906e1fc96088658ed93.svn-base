/**************************************************************************
 * $RCSfile: DMO_01.java,v $  $Revision: 1.4.6.1 $  $Date: 2009/01/16 08:51:28 $
 **************************************************************************/
package smartx.publics.styletemplet.bs.templet01;
...
public class DMO_01 {
    ...
    public HashMap dealCommit(String _dsName, String _bsInterceptName, BillVO[] _insertobjs, BillVO[] _deleteobjs,
        ...
        new CommDMO().executeBatchByDS(_dsName, v_sqls); //
 ...
 * *** empty log message ***
 *
 * Revision 1.1  2008/09/01 07:38:58  wangqi
 * *** empty log message ***
 *
 ...
 * code format
 *
 * Revision 1.1  2007/05/17 06:13:22  qilin
 * no message
 *
