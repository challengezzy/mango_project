/**************************************************************************
 * $RCSfile: TimePicker.java,v $  $Revision: 1.2 $  $Date: 2007/05/31 07:38:19 $
 **************************************************************************/
...
public final class TimePicker extends NovaDialog implements ItemListener {
    ...
    private final JLabel[] dayHeadings = new JLabel[] {new JLabel("日"), new JLabel("一"), new JLabel("二"),
    ...
    private final JLabel[][] daysInMonth = new JLabel[][] { {new JLabel(), new JLabel(), new JLabel(), new JLabel(),
        new JLabel(), new JLabel(), new JLabel()}, {new JLabel(), new JLabel(), new JLabel(), new JLabel(), new JLabel(),
        new JLabel(), new JLabel()}, {new JLabel(), new JLabel(), new JLabel(), new JLabel(), new JLabel(), new JLabel(),
        new JLabel()}, {new JLabel(), new JLabel(), new JLabel(), new JLabel(), new JLabel(), new JLabel(), new JLabel()},
        {new JLabel(), new JLabel(), new JLabel(), new JLabel(), new JLabel(), new JLabel(), new JLabel()}, {new JLabel(),
    ...
    public TimePicker(Container _parent, String _name, String info) {
        super(_parent, _name, 240, 310);
    ...
    public String getTimeStr() {
        if (null != selectedDate) {
            return dateToString(selectedDate.getTime()) + " " + this.time_return;
        }
        return null;
    }
    ...
    private void init() {
        ...
        todayButton.setBounds(35, 250, 40, 20);
        con.add(todayButton);

        assureButton.setBounds(90, 250, 40, 20);
        con.add(assureButton);

        cancelButton.setBounds(145, 250, 40, 20);
    ...
    private void onAssure(final java.awt.event.ActionEvent evt) {
        setVisible(!hideOnSelect);
        if (isVisible()) {
            monthAndYear.setText(formatDateText(selectedDate.getTime()));
            calculateCalendar();
    ...
    private void calculateCalendar() {
        ...
        final GregorianCalendar c = new GregorianCalendar(selectedDate.get(Calendar.YEAR),
    ...
    private static String formatDateText(final Date dt) {
        ...
        df.format(dt, mm, mmfp);
        df.format(dt, yy, yyfp);
        return (yy.toString().substring(yyfp.getBeginIndex(), yyfp.getEndIndex()) + " 年  " +
                mm.toString().substring(mmfp.getBeginIndex(), mmfp.getEndIndex()) + " 月 ");
    }
