 ...
 *
 */
public class QvInsertBfFormInterceptor implements FormInterceptor {

	QueryViewManager queryViewManager = new QueryViewManager();
	/* (non-Javadoc)
	...
	public void doSomething(Pub_Templet_1VO templetVO,
		...
		if(queryViewManager.isExistQv(dataValue.get("CODE")+""))
