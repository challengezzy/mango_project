 ...
 */
public class CustreceptionEventSource implements EventSourceAdapter, Runnable
{
	private Logger				logger			= Logger.getLogger( this.getClass() );

	public static final String	providerURI		= "DEFAULTPROVIDERNAME";
													
	public static final String	eventType		= "bvCustreceptionEvent";
	...
	public CustreceptionEventSource()
	{
