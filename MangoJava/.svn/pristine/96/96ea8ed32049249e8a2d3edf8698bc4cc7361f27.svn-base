/**************************************************************************
 * $RCSfile: Templet5RefPanel.java,v $  $Revision: 1.2 $  $Date: 2007/05/31 07:39:03 $
 **************************************************************************/
...
public class Templet5RefPanel extends AbstractTempletRefPars {
    private VectorMap paras = new VectorMap();
    ArrayList keys = new ArrayList();
    ArrayList values = new ArrayList();
    JTable table = null;
    private HashMap localname = new HashMap();
    Templet5CellEditor editor = null;
...
//		paras.put("sql", "select * from "+editor.getSelectedTablename());
    ...
    public Templet5RefPanel(String initString) {
        init(initString);
    }

    public Templet5RefPanel() {
        init("");
    }
    ...
    protected String bsInformation() {
        return "BS拦截器,需要实现IBSIntercept_05";
    }

    protected String uiInformation() {
        return "UI拦截器,需要实现IUIIntercept_05";
    }
}
/**************************************************************************
 * $RCSfile: Templet5RefPanel.java,v $  $Revision: 1.2 $  $Date: 2007/05/31 07:39:03 $
 *
 * $Log: Templet5RefPanel.java,v $
