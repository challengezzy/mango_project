/**************************************************************************
 * $RCSfile: TriggerInfo_VO.java,v $  $Revision: 1.2 $  $Date: 2007/05/31 07:38:24 $
 **************************************************************************/
...
public class TriggerInfo_VO extends AbstractTempletVO {
    ...
    private static int VO_LENGTH = 6;

    public TriggerInfo_VO() {
    }

    public TriggerInfo_VO(String _type) {
    }

    public HashVO getPub_templet_1Data() {
        HashVO vo = new HashVO(); //
        vo.setAttributeValue("templetcode", "triggerInfo"); //
        vo.setAttributeValue("templetname", "triggerInfo");
        vo.setAttributeValue("tablename", "USER_TRIGGERS");
        vo.setAttributeValue("pkname", "TRIGGER_NAME");
        vo.setAttributeValue("pksequencename", null);
        vo.setAttributeValue("savedtablename", "USER_TRIGGERS");
    ...
    public HashVO[] getPub_templet_1_itemData() {
        ...
        vos[li_index].setAttributeValue("itemkey", "TRIGGER_NAME"); //
        vos[li_index].setAttributeValue("itemname", "触发器名称");
        ...
        vos[li_index] = new HashVO();
        vos[li_index].setAttributeValue("itemkey", "TRIGGER_TYPE"); //
        vos[li_index].setAttributeValue("itemname", "触发器类别");
        vos[li_index].setAttributeValue("itemtype", "文本框");
        vos[li_index].setAttributeValue("comboxdesc", null);
        vos[li_index].setAttributeValue("refdesc", null);
        vos[li_index].setAttributeValue("issave", "Y");
        ...
        vos[li_index] = new HashVO();
        vos[li_index].setAttributeValue("itemkey", "TRIGGERING_EVENT"); //
        vos[li_index].setAttributeValue("itemname", "触发器事件");
        vos[li_index].setAttributeValue("itemtype", "文本框");
        vos[li_index].setAttributeValue("comboxdesc", null);
        vos[li_index].setAttributeValue("refdesc", null);
        vos[li_index].setAttributeValue("issave", "Y");
        ...
        vos[li_index] = new HashVO();
        vos[li_index].setAttributeValue("itemkey", "DESCRIPTION"); //
        vos[li_index].setAttributeValue("itemname", "触发器描述");
        vos[li_index].setAttributeValue("itemtype", "大文本框");
        vos[li_index].setAttributeValue("comboxdesc", null);
        vos[li_index].setAttributeValue("refdesc", null);
        vos[li_index].setAttributeValue("issave", "Y");
        vos[li_index].setAttributeValue("isdefaultquery", "N");
        ...
        vos[li_index].setAttributeValue("colorformula", null);
        vos[li_index].setAttributeValue("showorder", "1");
        vos[li_index].setAttributeValue("listwidth", "200");
        vos[li_index].setAttributeValue("cardwidth", "200");
        vos[li_index].setAttributeValue("listisshowable", "Y");
        vos[li_index].setAttributeValue("listiseditable", "Y");
        vos[li_index].setAttributeValue("cardisshowable", "Y");
        vos[li_index].setAttributeValue("cardiseditable", "Y");
        ...
        vos[li_index] = new HashVO();
        vos[li_index].setAttributeValue("itemkey", "TRIGGER_BODY"); //
        vos[li_index].setAttributeValue("itemname", "触发器主体");
        vos[li_index].setAttributeValue("itemtype", "大文本框");
        vos[li_index].setAttributeValue("comboxdesc", null);
        vos[li_index].setAttributeValue("refdesc", null);
        vos[li_index].setAttributeValue("issave", "Y");
