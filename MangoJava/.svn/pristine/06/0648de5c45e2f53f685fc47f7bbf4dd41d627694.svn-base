/**************************************************************************
 * $RCSfile: Templet6RefPanel.java,v $  $Revision: 1.2 $  $Date: 2007/05/31 07:39:04 $
 **************************************************************************/
...
public class Templet6RefPanel extends AbstractTempletRefPars {
    ...
    public Templet6RefPanel(String initString) {
        init(initString);
    }

    public Templet6RefPanel() {
        init("");
    }
    ...
    private void init(String initstring) {
        ...
        Templet6CellEditor editor = new Templet6CellEditor();
    ...
    protected String bsInformation() {
        return "BS拦截器,需要实现IBSIntercept_06";
    }

    protected String uiInformation() {
        return "UI拦截器,需要实现IUIIntercept_06";
    }
}
/**************************************************************************
 * $RCSfile: Templet6RefPanel.java,v $  $Revision: 1.2 $  $Date: 2007/05/31 07:39:04 $
 *
 * $Log: Templet6RefPanel.java,v $
 ...
 * no message
 *
 * Revision 1.4  2007/03/01 09:27:51  sunxf
 * 修改配置菜单时提示信息
 *
