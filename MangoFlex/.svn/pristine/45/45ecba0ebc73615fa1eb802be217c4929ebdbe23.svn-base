package smartx.flex.components.itemcomponent
{
	...
	public class ItemDateTimeField extends ItemUIComponent
	{
		private var dateTimeInput:DateTimeField = new DateTimeField();
		private var dateFormatter:DateFormatter = new DateFormatter();
		private var formatString:String = "YYYY-MM-DD JJ:NN:SS";
		
		public function ItemDateTimeField(templetItemVO:TempletItemVO,showLabel:Boolean=true)
		{
			...
			dateTimeInput.formatString = "YYYY-MM-DD HH:ii:ss";
		...
		public override function getQueryConditon(isPreciseQuery:Boolean=false):String{
			if(dateTimeInput.selectedDateTime == null)
				return "";
			return " and ("+templetItemVO.itemkey+" = to_date('"+stringValue+"','YYYY-MM-DD HH24:MI:SS')) ";
		}
		...
		public override function get sqlStringValue():String{
			...
			if(templetItemVO.itemtype.toLowerCase() == "date"){
				return 	"to_date('"+ stringValue + "','YYYY-MM-DD HH24:MI:SS')";
			}
			else{
				return "'"+stringValue+"'";
			}
    	...
    	public override function set data(value:Object):void {
        	...
        	if(value[templetItemVO.itemkey]!=null){
        		...
        		dateTimeInput.selectedDateTime = TempletDataUtil.stringToDate(str);  		
        	}	
        	else
        		dateTimeInput.selectedDateTime = null;
     	}
