...
package smartx.flex.components.util
{
	 ...
	 * same value. The Hashtable is preallocated according to an initial size, but
	...
	public class Hashtable
	{
		...
		private function initHashtable():void{
		...
		public function clear():void
		{
			...
			item = null;
			initHashtable();
			maxSize = initSize;//将最大容量设置为初始值，否则将导致headItem超出初始范围
		}
